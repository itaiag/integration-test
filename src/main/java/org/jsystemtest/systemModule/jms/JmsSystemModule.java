...
public class JmsSystemModule {
			...
			public Message createMessage(Session session) throws JMSException {
				...
				case TEXT:
					if (messageObject instanceof String) {
						...
						throw new IllegalArgumentException("Cannot send as text message object is not String " + type.name());
					}
				case OBJECT:
	...
	public Message receiveMessage(final String queueName, long timeout) throws JMSException {
		...
		if (null != message) {
			...
			messageReport.append("Message from type ").append(message.getClass().getSimpleName()).append(" was received");
